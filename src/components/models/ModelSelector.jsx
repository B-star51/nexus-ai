...
export default function ModelSelector({ compact = false, onChange }) {
  ...
  const [coords, setCoords] = useState({ left: 0, bottom: 0, width: 420 })
  ...
  // Position the fixed popup above the trigger
  useLayoutEffect(() => {
    ...
    <AnimatePresence>
      ...
      >
        ...
        <div style={{
          ...
          padding: '12px 16px 10px', borderBottom: '1px solid rgba(255,255,255,0.07)',
          ...
          {!hasModels ? (
            ...
            Object.entries(grouped).map(([providerId, { provider, models }]) => (
              <div key={providerId}>
                ...
                <div style={{
                  display: 'flex', alignItems: 'center', gap: 8, padding: '8px 14px 4px',
